                    ...
                    <div className="col-7 info">
                        <div className="product-details">
                            ...
                            <div>
                                ...
                                <Modal title={`Chi tiết thông số kĩ thuật ` + product.name} open={isModalOpen} onOk={handleOk} onCancel={handleCancel} style={{ padding: '0 !impotant' }}>
                                    <div class="card">
                                        ...
                                        <div class="card-body row">
                                            <div className="col-6">
                                                ...
                                                <li>Công nghệ màn hình: {product.screen.screenTechnology}</li>
                                        ...
                                        <div class="card-body row">
                                            <div className="col-6">
                                                <li><span style={{ fontSize: "20px", fontWeight: "600" }}>Card onboard</span></li>
                                                <li>Hãng: {product.cardOnboard.trandemark}</li>
                                                <li>Model: {product.cardOnboard.model}</li>
                                                <li>Bộ nhớ: {product.cardOnboard.memory}</li>
                                            </div>
                                            <div className="col-6">
                                                <li><span style={{ fontSize: "20px", fontWeight: "600" }}>Card rời</span></li>
                                        ...
                                        <div class="card-body row">
                                            <div className="col-6">
                                                ...
                                                <li>Loại SSD:{product.storage.storageDetail.storageType.name}</li>
                                    ...
                                    {products.map(pro => (
                                        <div className="product col-2" key={pro.id}>
                                            ...
                                            <div className="product-body">
                                                ...
                                                <h3 className="product-name" onClick={() => handelCLickProduct(pro)} style={{ wordWrap: 'break-word' }} ><a href="/user/product">{pro.name}</a></h3>
