...
const Find = () => {
    ...
    const getDataProducts = () => {
        axios.get(`http://localhost:8080/api/products/getAllProAccess` + `?${qs.stringify(
    ...
    dataManufacture?.map(item => {thuonghieuOptions.push({label:item.name,value:item.id})})
    ...
    //option CPU
    const cpuOptions=[];
    processorsFilter?.map(item => {cpuOptions.push({label:item.cpuCompany.trim() +" " +item.cpuTechnology.trim(),value:item.cpuCompany.trim() +" " +item.cpuTechnology.trim()})})
    ...
    category?.map(item => {categoryOptions.push({label:item.name.trim(),value:item.name.trim()})})
    ...
    const onChangecategory = (list) => {
      ...
      setCheckAllcategory(list.length === categoryOptions.length||list.length ==0);
    ...
    const chonLaptop=()=>{
      ...
      for(var i=0; i<arr2.length; i++){
        if(giabanAll[0].control.checked == true){
          ...
          if (arr2[i].control.checked==true) giaban_arr.push(arr2[i].control.value);
        }
      }
      ...
      for(var i=0; i<arr3.length; i++){
        if(manhinhAll[0].control.checked == true){
          ...
          if (arr3[i].control.checked==true) manhinh_arr.push(arr3[i].control.value);
        }
      }
      ...
      for(var i=0; i<arr4.length; i++){
        if(cpuAll[0].control.checked == true){
          ...
          if (arr4[i].control.checked==true) cpu_arr.push(arr4[i].control.value);
        }
      }
      ...
      for(var i=0; i<arr5.length; i++){
        if(ramAll[0].control.checked == true){
          ...
          if (arr5[i].control.checked==true) ram_arr.push(arr5[i].control.value);
        }
      }
      ...
      for(var i=0; i<arr6.length; i++){
        if(cardAll[0].control.checked == true){
          ...
          if (arr6[i].control.checked==true) card_arr.push(arr6[i].control.value);
        }
      }
      ...
      for(var i=0; i<arr7.length; i++){
        if(ocungAll[0].control.checked == true){
          ...
          if (arr7[i].control.checked==true) storage_arr.push(arr7[i].control.value);
        }
      }
      ...
      for(var i=0; i<arr8.length; i++){
        if(categoryAll[0].control.checked == true){
          ...
          if (arr8[i].control.checked==true) category_arr.push(arr8[i].control.value);
        }
      }
      hienLT(thuonghieuchon_arr, giaban_arr ,manhinh_arr, cpu_arr, ram_arr,  card_arr, storage_arr, category_arr);
    }
    function hienLT(thuonghieuchon_arr, giaban_arr ,manhinh_arr, cpu_arr, ram_arr, card_arr, storage_arr, category_arr){
      ...
      for(var i=0; i<dataProducts?.length; i++){
        ...
        var cpuLT=dataProducts[i].processor.cpuCompany.trim() +" " +dataProducts[i].processor.cpuTechnology.trim();
        var ramLT=dataProducts[i].ram.ramCapacity.split(" ")[0].trim();
        var cardLT=dataProducts[i].card.trandemark.trim();
        var storageLT=dataProducts[i].storage.storageDetail.capacity.split(" ")[0].trim();
        var categoryLT=dataProducts[i].categoryProducts;
        if(thuonghieuchon_arr?.length>0){
          if(thuonghieuchon_arr.includes(thuonghieuLT)==true) {ktThuonghieu=true;}
          if(thuonghieuchon_arr.includes(thuonghieuLT)==false) continue;
        }
        if(giaban_arr?.length>0){
          if ((giaLT< 10000000 && giaban_arr.includes('1')==true)||
          (giaLT>=10000000 && giaLT<15000000 && giaban_arr.includes('2')==true)||
          (giaLT>=15000000 && giaLT<20000000 && giaban_arr.includes('3')==true)||
          (giaLT>=20000000 && giaban_arr.includes('4')==true)
          ) {ktGiaban=true;}
          if (giaLT< 10000000 && giaban_arr.includes('1')==false) continue;
          if (giaLT>=10000000 && giaLT<15000000 && giaban_arr.includes('2')==false) continue;
          if (giaLT>=15000000 && giaLT<20000000 && giaban_arr.includes('3')==false) continue;
          if (giaLT>=20000000 && giaban_arr.includes('4')==false) continue;
        }
        if(manhinh_arr?.length>0){
          if ((manhinhLT>=13 && manhinhLT<14 && manhinh_arr.includes('1')==true)||
          (manhinhLT>=14 && manhinhLT<15 && manhinh_arr.includes('2')==true)||
          (manhinhLT>=15 && manhinh_arr.includes('3')==true)
          ) {ktManhinh=true;}
          if (manhinhLT>=13 && manhinhLT<14 && manhinh_arr.includes('1')==false) continue;
          if (manhinhLT>=14 && manhinhLT<15 && manhinh_arr.includes('2')==false) continue;
          if (manhinhLT>=15 && manhinh_arr.includes('3')==false) continue;
        }
        if(cpu_arr?.length>0){
          if(cpu_arr.includes(cpuLT)==true){ktCPU=true;}
          if(cpu_arr.includes(cpuLT)==false) continue;
        }
        if(ram_arr?.length>0){
          if ((ramLT==4 && ram_arr.includes('1')==true)||
        ...
        if(card_arr?.length>0){
          if ((cardLT=="NVIDIA" && card_arr.includes('1')==true)||
        ...
        if(storage_arr?.length>0){
          if ((storageLT==1 && storage_arr.includes('1')==true)||
            ...
            <div className="row">
                <div className="col-3">
                    ...
                    >
                        ...
                        <Col span={10}>
                        <Checkbox className="thuonghieuAll"  onChange={onCheckAllChangeThuongHieu} checked={checkAllTH}>
                          Tất cả
                        </Checkbox>
                        <Checkbox.Group className="thuonghieu" options={thuonghieuOptions} value={checkedListTH} onChange={onChangeThuongHieu} />
                        </Col>
                    ...
                    >
                      {/* <Checkbox.Group onChange={chonLaptop}>
                        ...
                        <Col span={12}>
                        <Checkbox className="giabanAll"  onChange={onCheckAllChangegiaban} checked={checkAllGB}>
                          Tất cả
                        </Checkbox>
                        <Checkbox.Group className="giaban" options={giabanOptions} value={checkedListGB} onChange={onChangegiaban} />
                        </Col>
                    </Card>
                    <Card
                        className="mt-2"
                    ...
                    >
                        ...
                        <Col span={12}>
                        <Checkbox className="manhinhAll"  onChange={onCheckAllChangemanhinh} checked={checkAllMH}>
                          Tất cả
                        </Checkbox>
                        <Checkbox.Group className="manhinh" options={manhinhOptions} value={checkedListMH} onChange={onChangemanhinh} />
                        </Col>
                    </Card>
                    <Card
                        className="mt-2"
                    ...
                    >
                        ...
                        <Col span={12}>
                        <Checkbox className="cpuAll"  onChange={onCheckAllChangecpu} checked={checkAllCPU}>
                          Tất cả
                        </Checkbox>
                        <Checkbox.Group className="cpu" options={cpuOptions} value={checkedListCPU} onChange={onChangecpu} />
                        </Col>
                    ...
                    >
                        ...
                        <Col span={12}>
                        <Checkbox className="ramAll"  onChange={onCheckAllChangeram} checked={checkAllRam}>
                          Tất cả
                        </Checkbox>
                        <Checkbox.Group className="ram" options={ramOptions} value={checkedListRam} onChange={onChangeram} />
                        </Col>
                    </Card>
                    <Card
                        className="mt-2"
                    ...
                    >
                        ...
                        <Col span={12}>
                        <Checkbox className="cardAll"  onChange={onCheckAllChangecard} checked={checkAllcard}>
                          Tất cả
                        </Checkbox>
                        <Checkbox.Group className="cardDohoa" options={cardOptions} value={checkedListcard} onChange={onChangecard} />
                        </Col>
                    </Card>
                    <Card
                        className="mt-2"
                    ...
                    >
                        ...
                        <Col span={12}>
                        <Checkbox className="ocungAll"  onChange={onCheckAllChangeocung} checked={checkAllocung}>
                          Tất cả
                        </Checkbox>
                        <Checkbox.Group className="ocung" options={ocungOptions} value={checkedListocung} onChange={onChangeocung} />
                        </Col>
                    </Card>
                    <Card
                        className="mt-2"
                    ...
                    >
                        ...
                        <Col span={12}>
                        <Checkbox className="categoryAll"  onChange={onCheckAllChangecategory} checked={checkAllcategory}>
                          Tất cả
                        </Checkbox>
                        <Checkbox.Group className="category" options={categoryOptions} value={checkedListcategory} onChange={onChangecategory} />
                        </Col>
                    </Card>
                </div>
                <div className="col-9">
                                ...
                                <div className="product">
                                    ...
                                    <div className="product-body">
                                        ...
                                        <div className="text-secondary">
                                            ...
                                            </svg>{item.storage?.storageDetail.storageType.name.trim()+" "+item.storage?.storageDetail.capacity.trim()}
                                            </Tooltip>
                                            </div>
                                            <div>
